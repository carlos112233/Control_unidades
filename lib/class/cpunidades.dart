...
CpUnidades cpUnidadesFromJson(String str) =>
    CpUnidades.fromJson(json.decode(str));

String cpUnidadesToJson(CpUnidades data) => json.encode(data.toJson());
...
class CpUnidades {
  ...
  factory CpUnidades.fromJson(Map<String, dynamic> json) => CpUnidades(
